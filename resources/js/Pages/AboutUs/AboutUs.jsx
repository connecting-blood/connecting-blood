    ...
    return (
        <UserLayout>
            <div className="flex justify-center items-center flex-col space-y-10 py-7">
                <h1 className='text-primary text-3xl font-bold w-1/2 text-center'>Our mission is to give hope a Lifeline, one drop at a time</h1>
            ...
            <div className="flex justify-center items-center flex-col space-y-10">
                ...
                <h2 className='text-primary text-2xl font-semibold'>Our Journey Milestones</h2>
                <div className='grid lg:grid-cols-4 grid-rows-1 gap-4 w-10/12'>
                    {milestones.map((item, index) => (<div key={index.toString()} className='flex flex-col justify-center items-center space-y-2'>
                            <item.Icon className='text-black w-10 h-10' />
