        ...
        <Card className="overflow-hidden">
          <CardContent className="grid p-0 md:grid-cols-2">
            <form className="p-6 md:p-8" onSubmit={submit_2}>
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Button disabled={processing} variant="outline" className="w-full">
                ...
                <div className="text-center text-sm">
                  ...
                  <Link disabled={processing} href={route('register')} className="underline underline-offset-4">
                    Sign up
                  </Link>
                </div>
              </div>
            ...
            <div className="relative hidden bg-muted md:block">
              <img
                src='/storage/website/webp/person-holding-heart-shaped-object.webp'
                alt="Image"
